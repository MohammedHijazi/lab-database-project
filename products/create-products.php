                                ...
                                <div class="row">
                                    <div class="col-md-12 personal-info">
                                        <form method="POST" action="products.php">
                                            ...
                                            <div class="form-group row">
                                                <label for="name" class="col-md-4 col-form-label text-md-right">Category ID</label>
                                                <div class="col-md-3">
                                                    <input  type="text" class="form-control"  name="category_id"  required autofocus>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-0">
                                                <div class="col-md-6 offset-md-4">
                                                    <button name="insert_product" type="submit" class="btn btn-primary">
                                                        Save
                                                    </button>
                                                </div>
                                            </div>
